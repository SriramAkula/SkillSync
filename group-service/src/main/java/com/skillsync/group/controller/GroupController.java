...
public class GroupController {
    ...
    public ResponseEntity<ApiResponse<GroupResponseDto>> createGroup(
        ...
        if (roles == null || !roles.contains("ROLE_MENTOR")) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Only mentors can create learning groups");
        }
    ...
    public ResponseEntity<ApiResponse<GroupResponseDto>> joinGroup(
        ...
        if (roles == null || !roles.contains("ROLE_LEARNER")) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Only learners can join groups");
        }
    ...
    public ResponseEntity<ApiResponse<GroupResponseDto>> leaveGroup(
        ...
        if (roles == null || !roles.contains("ROLE_LEARNER")) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Only learners can leave groups");
        }
    ...
    public ResponseEntity<ApiResponse<GroupResponseDto>> deleteGroup(
        ...
        if (roles == null || !roles.contains("ROLE_MENTOR")) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Only mentors can delete groups");
        }
