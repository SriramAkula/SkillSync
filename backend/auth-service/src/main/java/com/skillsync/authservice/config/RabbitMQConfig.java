...
public class RabbitMQConfig {
    ...
    public DefaultClassMapper classMapper() {
        ...
        idClassMapping.put("user_created", com.skillsync.authservice.event.UserCreatedEvent.class);
        idClassMapping.put("user_updated", com.skillsync.authservice.event.UserUpdatedEvent.class);
