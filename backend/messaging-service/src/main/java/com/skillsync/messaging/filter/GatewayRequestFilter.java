...
/**
 * Filter to enforce that requests to this service come through the API Gateway.
 * Validates the presence of the X-Gateway-Request header.
 */
@Component
public class GatewayRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (requestPath.startsWith("/actuator") ||
            ...
            requestPath.startsWith("/messaging/v3/api-docs")) {
            filterChain.doFilter(request, response);
            return;
        }
