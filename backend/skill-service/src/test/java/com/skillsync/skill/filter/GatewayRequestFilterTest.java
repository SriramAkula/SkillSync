...
class GatewayRequestFilterTest {
    ...
    void doFilter_shouldAllowInternalPaths() throws ServletException, IOException {
        when(request.getRequestURI()).thenReturn("/skill/internal/validate");
    ...
    void doFilter_shouldAllowWithGatewayHeader() throws ServletException, IOException {
        when(request.getRequestURI()).thenReturn("/skill/1");
    ...
    @Test
    void doFilter_shouldAllowWithValidAuthHeader() throws ServletException, IOException {
        when(request.getRequestURI()).thenReturn("/skill/1");
    ...
    @Test
    void doFilter_shouldAllowSwaggerApiDocs() throws ServletException, IOException {
    ...
    @Test
    void doFilter_shouldAllowSwaggerUi() throws ServletException, IOException {
    ...
    @Test
    void doFilter_shouldAllowSwaggerResources() throws ServletException, IOException {
